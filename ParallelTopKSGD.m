function [Fcn, Coordinates_sent] = ParallelTopKSGD(A,b,Iter,beta,delta,num_group,K)
...
if mod(k,1000) == 0 
fprintf('Parallel TopK SGD with num_worker = %d: Function = %d    Coordinates sent = %d     Time = %d \n',num_group,Fcn(k),K,time);    
end
